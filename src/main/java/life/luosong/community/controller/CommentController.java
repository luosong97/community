...
import life.luosong.community.dto.CommentCreateDTO;
...
import life.luosong.community.service.CommentService;
...
public class CommentController {
    ...
    @ResponseBody
    @RequestMapping(value = "/comment",method = RequestMethod.POST)  //评论
